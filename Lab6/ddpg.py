        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                writer.add_scalar('Train/Ewma Reward', ewma_reward,
                                  total_steps)
                print(f'Step:{total_steps:10} | Episode: {episode:4} | Length: {t:4} | Total reward: {total_reward:7.2f} | Ewma reward: {ewma_reward:7.2f}')
                break
    env.close()
...
def main():
    ...
    # parser.add_argument('--episode', default=3, type=int)
