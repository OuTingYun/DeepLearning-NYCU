...
class Decoder(nn.Module):
    ...
    def __init__(self, z_dim):
        ...
        self.decoder_residual_blocks = nn.ModuleList([
            DecoderResidualBlock(z_dim // 2, n_group=4),    # up_sampling
            ...
            DecoderResidualBlock(z_dim // 8, n_group=2),    # up_sampling

            DecoderResidualBlock(z_dim // 8, n_group=2),
            DecoderResidualBlock(z_dim // 8, n_group=2),
            DecoderResidualBlock(z_dim // 8, n_group=2),

            DecoderResidualBlock(z_dim // 32, n_group=1)    # up_sampling
        ])
        ...
        self.condition_z = nn.ModuleList(z_list)    #14
        ...
        self.condition_xz = nn.ModuleList(xz_list)  #14
